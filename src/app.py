...
EMAIL_CONFIG = {
    ...
    'sender_password': os.environ.get('EMAIL_PASSWORD', 'kvj21mn1ak_'),  # Store password in environment variable
...
def display_detailed_metrics(filter_data, selected_month, selected_year, selected_shape,
    ...
    try:
        ...
        # Reduced from 7 to 4 to hide MoM Variance, MoM % Change, QoQ % Change
        ...
        metrics_data = [
            ...
            # Hidden per user request - can be re-enabled if needed
